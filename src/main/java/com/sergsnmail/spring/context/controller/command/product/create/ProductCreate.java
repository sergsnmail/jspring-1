package com.sergsnmail.spring.context.controller.command.product.create;
...
public class ProductCreate extends Command<ProductCreateParam> {
    ...
    public static ProductCreate.CreateBuilder builder () {
        return new ProductCreate.CreateBuilder();
    }
